...
def play_state_1(ai_bot, hand, small_blind_amount, raise_state):
    ...
    if raise_state[0] == False:
        ...
        if chen_score >= 10: # AI has Strong Hand
            ...
            if chen_score > 5:
                ...
                if raise_state[1] > ai_bot.chips // 2 and small_blind_amount < ai_bot.chips // 6: # Raise by player is greater than half of ai's chips and small big blind
                ...
                elif raise_state[1] > ai_bot.chips // 2 and small_blind_amount >= ai_bot.chips // 6: # Raise by player is greater than half of ai's chips and large big blind
                ...
                elif raise_state[1] <= ai_bot.chips // 2 and small_blind_amount < ai_bot.chips // 6: # Raise by player is less than half of ai's chips. and small big blind
                ...
                elif raise_state[1] <= ai_bot.chips // 2 and small_blind_amount >= ai_bot.chips // 6: # Raise by player is less than half of ai's chips and large big blind
                    x = random.randint(1, 51)
                ...
                if raise_state[1] > ai_bot.chips // 2 and small_blind_amount < ai_bot.chips // 6: # Raise by player is greater than half of ai's chips and small big blind
                    ...
                    if small_blind_amount > ai_bot.chips // 3: # Very Large min bet
